  ...
  return (
    <>
      {loop.map((items,index)=>{return (
              <Card className="w-[270px] h-full overflow-hidden grow-0 shrink-0">
              {/* Top Image */}
              <div key={index} className="relative w-full h-[250px] bg-[#F5F5F5] p-3 flex justify-center items-center">
