...
const GLOBE_CONFIG: COBEOptions = {
  ...
  theta: 0.3,
  dark: 0,
  diffuse: 0.7,         // Light reflection zyada
  mapSamples: 16000,
  mapBrightness: 1.6,   // Brightness zyada
  baseColor: [0.2, 0.6, 1],     // Soft blue base color
  markerColor: [1, 0.4, 0],     // Bright orange markers
  glowColor: [0.9, 0.6, 0.2],   // Warm yellow glow
  markers: [
    ...
    { location: [19.4326, -99.1332], size: 0.11 },
